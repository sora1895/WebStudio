CREATE DATABASE  IF NOT EXISTS `studioweb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `studioweb`;
...
INSERT INTO `contract` VALUES (1,1,1,'This guy want a photoshot for his wedding','2018-06-03','2018-06-05','2018-06-10'),(2,1,2,'aaaaa','2018-03-11','2018-03-11','2018-03-11'),(3,1,1,'Something ','2018-03-23','2018-03-31','2018-04-04');
...
INSERT INTO `contractdetail` VALUES (1,1,1,'Ha Long weeding photoshoot','Ha Long bay',5000000,'nothing'),(4,2,1,'test','this package is for testing',100000000,'a'),(5,1,1,'test','this package is for testing',100000000,'a'),(6,3,1,'Ha Long weeding photoshoot','Ha Long bay',5000,'zzz');
...
INSERT INTO `customer` VALUES (1,'Mr Moe','Male','30 Hang Thung','moe@gmail.com','01689181825','nothing');
...
INSERT INTO `package` VALUES (1,1,'Ha Long weeding photoshoot','do photoshoot at Ha Long bay',10000000,1),(2,1,'Nha Trang Resort','do photoshoot at Nha Trang',20000000,1);
...
INSERT INTO `picture` VALUES (1,1,'Cat','/picture/kitten.jpg'),(4,4,'This pIcture is for testing','https://img-9gag-fun.9cache.com/photo/anMjjmV_460swp.webp'),(5,1,'This pIcture is for testing','https://img-9gag-fun.9cache.com/photo/anMjjmV_460swp.webp'),(6,6,'asd','/picture/kitten.jpg');
...
CREATE TABLE `printingmaterial` (
  ...
  `Material_Des` varchar(4000) NOT NULL,
...
INSERT INTO `printingmaterial` VALUES (1,'Paper','Paper is made of wood'),(3,'Plastic',''),(6,'Rock','Rock is 1000 years old');
...
CREATE TABLE `printmaterialprice` (
  ...
  `MaterialPrice_Size` varchar(1000) NOT NULL,
  `MaterialPrice_Price` int(11) NOT NULL,
  PRIMARY KEY (`MaterialPrice_ID`),
  KEY `printmaterialprice_ibfk_2` (`Material_ID`),
...
INSERT INTO `printmaterialprice` VALUES (1,1,'A4: 279.4mm x 210mm',100000),(3,3,'A3',10000),(5,6,'A2',1000);
...
INSERT INTO `printorder` VALUES (1,1,'2018-06-15','2018-06-15','2018-06-18'),(3,2,'2018-03-14','2018-03-30','2018-03-31'),(4,3,'2018-03-22','2018-03-24','2018-03-20'),(5,3,'2018-03-06','2018-03-15','2018-03-13');
...
CREATE TABLE `printorderdetail` (
  ...
  `OrderDetail_Size` varchar(4000) NOT NULL,
  `OrderDetail_Price` varchar(15) NOT NULL,
  `OrderDetail_Note` varchar(1000) NOT NULL,
  KEY `MaterialPrice_ID` (`MaterialPrice_ID`),
  KEY `PrintOrder_ID` (`PrintOrder_ID`),
  KEY `Picture_ID` (`Picture_ID`),
  CONSTRAINT `printorderdetail_ibfk_1` FOREIGN KEY (`MaterialPrice_ID`) REFERENCES `printmaterialprice` (`MaterialPrice_ID`),
  CONSTRAINT `printorderdetail_ibfk_2` FOREIGN KEY (`PrintOrder_ID`) REFERENCES `printorder` (`PrintOrder_ID`),
  CONSTRAINT `printorderdetail_ibfk_3` FOREIGN KEY (`Picture_ID`) REFERENCES `picture` (`Picture_ID`)
...
INSERT INTO `printorderdetail` VALUES (1,1,1,10,'A4','1000000','nothing'),(1,5,1,13,'A1','1300000','aa');
...
INSERT INTO `studio` VALUES (1,529,'StudioWeb','30 HANG THUNG','mail@gmail.com','0123456789','123123132'),(2,1,'a','a','a','11111','0');
...
INSERT INTO `user` VALUES ('admin',1,'admin','admin1'),('moe',1,'user','moe1');
...
-- Dump completed on 2018-03-27 18:59:44

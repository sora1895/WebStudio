...
exports.GetPackByName = function (req, res) {
  ...
  console.log(name);
  connection.query('SELECT * FROM Package WHERE Package_Name=?',[name], function (error, results, fields) {
    if (error) {
      res.send({
        "code": 400,
        "failed": "error ocurred"
...
exports.GetPackIdByName = function (req, res) {
  ...
  console.log(name);;
  connection.query('SELECT Package_ID FROM Package WHERE Package_Name=?',[name], function (error, results, fields) {
    if (error) {
      res.send({
        "code": 400,
        "failed": "error ocurred"
